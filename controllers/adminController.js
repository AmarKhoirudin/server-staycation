...
module.exports = {
  ...
  deleteBank: async (req, res) => {
    try {
      ...
      await fs.unlink(path.join(`public/${bank.imageUrl}`));
      await bank.remove();
      req.flash("alertMessage", "Sucess Delete Bank");
      req.flash("alertStatus", "success");
      res.redirect("/admin/bank");
    } catch (error) {
      req.flash("alertMessage", `${error.message}`);
  ...
  addItem: async (req, res) => {
    try {
      ...
      if (req.files.length > 0) {
        ...
        req.flash("alertMessage", "Sucess Add Item");
        req.flash("alertStatus", "success");
        res.redirect("/admin/item");
      }
    } catch (error) {
  ...
  deleteItem: async (req, res) => {
    try {
      ...
      for (let i = 0; i < item.imageId.length; i++) {
        Image.findOne({ _id: item.imageId[i] })
          .then((image) => {
  ...
  editFeature: async (req, res) => {
    ...
    try {
      ...
      if (req.file == undefined) {
        ...
        await feature.save();
        req.flash("alertMessage", "Success Update Feature Dengan image");
        req.flash("alertStatus", "success");
        res.redirect(`/admin/item/show-detail-item/${itemId}`);
      }
    } catch (error) {
  ...
  editActivity: async (req, res) => {
    ...
    try {
      ...
      if (req.file === undefined) {
        ...
        await activity.save();
        req.flash("alertMessage", "Success Update activity dengan gambar");
        req.flash("alertStatus", "success");
        res.redirect(`/admin/item/show-detail-item/${itemId}`);
      }
    } catch (error) {
